...
# session_state persists the selected country across reruns AND across pages
...
with tab1:
    # BBD/SWD COLOUR TYPE: highlight — one bold colour, all others grey,
...
with tab2:
    # BBD/SWD COLOUR TYPE: highlight — selected country vs grey peer group
